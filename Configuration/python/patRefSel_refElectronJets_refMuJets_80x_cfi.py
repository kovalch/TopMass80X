...
preSignalElectrons = selectedPatElectrons.clone(
  src = cms.InputTag( 'selectedElectrons' )
, cut = '' 
)

#TODO old and wrong???
#signalElectrons = preSignalElectrons.clone(
#  electronSource   = cms.InputTag( 'preSignalElectrons' )
#)

signalElectrons = preSignalElectrons.clone(
  src   = cms.InputTag( 'preSignalElectrons' )
)

standAloneSignalElectronFilter = cms.EDFilter(
...
LooseMuonVetoFilter = cms.EDFilter(
  "PATCandViewCountFilter"
, src       = cms.InputTag( 'selectedMuons' )
...
selectedElectrons4Veto = selectedPatElectrons.clone(
  src = cms.InputTag( 'patElectrons' )
, cut = ''
)

dileptonElectronVetoFilter = cms.EDFilter(
  "PATCandViewCountFilter"
, src       = cms.InputTag( 'selectedElectrons4Veto' )
, minNumber = cms.uint32( 0 )
, maxNumber = cms.uint32( 1 )
)
...
conversionRejectionFilter = selectedPatElectrons.clone(
src       = cms.InputTag( 'signalElectrons' )
, cut	    = '' #conversionRejectionCut
, minNumber = cms.uint32( 1 )
, maxNumber = cms.uint32( 1 ) 
)
