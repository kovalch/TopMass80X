...
options.register('runOnPythia8', True, VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.bool, "run on Pythia8")
...
if topfilter:
    ...
    #----- test Lukas implementation for pythia8
