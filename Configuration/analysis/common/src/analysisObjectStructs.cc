...
void RecoObjects::clear()
{
    ...
    lepCombIso_ = 0;
    lepDxyVertex0_ = 0;
    if(lepDzVertex0_) lepDzVertex0_ = 0;
    //lepTrigger_ = 0;
    jets_ = 0;
    jetBTagTCHE_ = 0;
    //jetBTagTCHP_ = 0;
    ...
    if(jetSecondaryVertex_) jetSecondaryVertex_ = 0;
    if(jetSecondaryVertexFlightDistanceValue_) jetSecondaryVertexFlightDistanceValue_ = 0;
    if(jetSecondaryVertexFlightDistanceSignificance_) jetSecondaryVertexFlightDistanceSignificance_ = 0;
    if(jetSecondaryVertexTrack_) jetSecondaryVertexTrack_ = 0;
    if(jetSecondaryVertexTrackJetIndex_) jetSecondaryVertexTrackJetIndex_ = 0;
    if(jetSecondaryVertexTrackVertexIndex_) jetSecondaryVertexTrackVertexIndex_ = 0;
    met_ = 0;
    jetJERSF_ = 0;
    jetsForMET_ = 0;
    jetForMETJERSF_ = 0;
