...
echo
echo
echo "Compiling project common using cmake/make"
echo "Source code in folder: ${commonSourceDir}"
echo "Installation in folder: ${commonInstallDir}"
echo
if [ ! -d "${commonInstallDir}/build_common" ]; then
    mkdir ${commonInstallDir}/build_common
fi
cd ${commonInstallDir}/build_common
