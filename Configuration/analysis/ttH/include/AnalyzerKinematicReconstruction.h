#ifndef AnalyzerKinematicReconstruction_h
#define AnalyzerKinematicReconstruction_h
...
class AnalyzerKinematicReconstruction : public AnalyzerBase{

public:
    
    /// Constructor
    AnalyzerKinematicReconstruction(const std::vector<TString>& selectionStepsNoCategories,
