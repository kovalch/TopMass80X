#ifndef MvaTreeHandlerEventClassification_h
#define MvaTreeHandlerEventClassification_h
...
/// categorising events by their ttH-likeliness
class MvaTreeHandlerEventClassification : public MvaTreeHandlerBase{
    
public:
    
    /// Constructor for selection steps
    MvaTreeHandlerEventClassification(const char* mvaInputDir,
