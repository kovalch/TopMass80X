#ifndef MvaTreePlotterEventClassification_h
#define MvaTreePlotterEventClassification_h
...
class MvaTreePlotterEventClassification : public MvaTreePlotterBase{
    
public:
    
    /// Constructor for selection steps
    MvaTreePlotterEventClassification(const std::map<TString, std::vector<MvaVariablesBase*> >& m_stepMvaVariables,
