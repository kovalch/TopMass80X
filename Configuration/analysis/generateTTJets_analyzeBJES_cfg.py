...
options.register('tune', 'Z2', VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.string, "MC campaign or data")
options.register('rb', 1.0, VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.float, "rb for fragmentation")
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTJets_MSDecays_central_8TeV-madgraph_bfrag_r_hard_step1.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        fragSettings = cms.vstring(
            'MSTJ(11) = 5           ! Fragmentation model',
            #'PARJ(47) = 0.4725969   ! HAD Lund(=0)-Bowler(=1) rQ (b)',
            #'PARJ(47) = 0.6947239   ! HAD Lund(=0)-Bowler(=1) rQ (b)',
            'PARJ(47) = ' + str(options.rb), # HAD Lund(=0)-Bowler(=1) rQ (b)', 
            
            #'PARJ(81) = 0.205 ! less FSR, 0.29/sqrt(2)',
            #'PARP(64)=4.',
	          #'PARP(72)=0.125',
        ),
        parameterSets = cms.vstring('pythiaUESettings', 
            'processParameters', 'fragSettings')
    )
)
...
# Schedule definition
process.schedule = cms.Schedule(process.generation_step, process.genfiltersummary_step, process.validation_step, process.endjob_step, process.RAWSIMoutput_step, process.bJES_step)
