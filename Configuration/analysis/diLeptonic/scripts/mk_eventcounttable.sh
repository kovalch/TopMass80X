...
do
  ...
  do
    ...
    #tt+V boson
    tempttV=`grep "t#bar{t}+V" $sample/Events$step.txt | awk -F : '{print $2;}'`
...
echo "           \\\ttbar+V         &     $ttVmumu5  &       $ttVmumu6   &       $ttVmumu7   &       $ttVmumu8  & $ttVmumu9  \\\\\\"
...
echo "           \\\ttbar+V         &     $ttVemu5  &       $ttVemu6   &       $ttVemu7   &       $ttVemu8  & $ttVemu9  \\\\\\"
...
echo "           \\\ttbar+V         &     $ttVee5  &       $ttVee6   &       $ttVee7   &       $ttVee8  & $ttVee9  \\\\\\"
...
echo "           \\\ttbar+V         &     $ttVcombined5  &       $ttVcombined6   &       $ttVcombined7   &       $ttVcombined8  & $ttVcombined9  \\\\\\"
