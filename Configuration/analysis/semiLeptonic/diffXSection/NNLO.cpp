...
// mkdir InputFiles
// mkdir ROOTFiles
// cp /afs/naf.desy.de/group/cms/scratch/tophh/CommonFiles/pttopnnloapprox8lhc173m.dat InputFiles/topPt.txt
// cp /afs/naf.desy.de/group/cms/scratch/tophh/CommonFiles/ytopnnloapprox8lhc173m.dat InputFiles/topY.txt
// cd InputFiles
...
NNLO::NNLO(TString plotname, bool verbose){
	...
	const double topPtBins[] = { 1.0, 60.0, 100.0, 150.0, 200.0, 260.0, 320.0, 400.0, 500.0, 1500    };  
