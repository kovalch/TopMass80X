...
/**
   \class   TopDecaySubsetLocal TopDecaySubsetLocal.h "TopQuarkAnalysis/TopEventProducers/interface/TopDecaySubsetLocal.h"
...
class TopDecaySubsetLocal : public edm::EDProducer {
 ...
 public:
  ...
  /// default constructor
  explicit TopDecaySubsetLocal(const edm::ParameterSet& cfg);
  /// default destructor
  ~TopDecaySubsetLocal();
...
//  const reco::GenParticle* findDecayingW(const reco::GenParticle* top);
 ...
 private:
  ...
  edm::InputTag srcToken_;
  /// input tag for the genEventInfo source
  edm::InputTag genEventInfo_srcToken_;
