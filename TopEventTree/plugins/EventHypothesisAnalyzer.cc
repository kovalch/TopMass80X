...
hypoClassKey_(consumes<int>(cfg.getParameter<edm::InputTag>("hypoClassKey"))),
ttEventGen2_ (cfg.getParameter<edm::InputTag>("ttEventGen2")),

// jets_        (consumes<std::vector<pat::Jet>>(cfg.getParameter<edm::InputTag>("jets"))), // needed in fullHad channel for reco masses
...
//   mayConsume<std::vector<pat::Jet>>(jets_);
...
//     edm::Handle<std::vector<pat::Jet> > hJets;
  ...
  evt.getByToken(hypoClassKey_, hypoClassKeyHandle);
