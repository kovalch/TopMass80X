...
//TString sPath("/scratch/hh/dust/naf/cms/user/eschliec/topmass_120509_1100/");
//TString sPath("/scratch/hh/dust/naf/cms/user/eschliec/topmass_120510_1200/");
//TString sPath("/scratch/hh/dust/naf/cms/user/eschliec/topmass_120522_1500/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_120522_1500/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_120605_1400/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_120609_1302/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_120615_1502k/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_120810_1202d/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_121004_2002a/");
//TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_121114_1901a/");
TString sPath("/scratch/hh/current/cms/user/eschliec/topmass_121126_1601b/");
//TString sPath("");
...
void ensembleTreeSys()
{
  ...
  //ensembles.push_back(ensemble("ensemble_F11_jes_down.root", true, 0.988));
  //ensembles.push_back(ensemble("ensemble_F11_jes_up.root", true, 1.012));
