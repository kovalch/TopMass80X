...
private:
  ...
  class MyHistogram{
  public:
    MyHistogram(std::string name_, std::string formulax_, TChain* chain_, std::string title, int nBins, double min, double max) :
      name(name_), formulax(formulax_), formulay("1."), chain(chain_),
      ...
      isTwoDHistogram(false)
    {
      ...
      MyHistogram(std::string name_, std::string formulax_, std::string formulay_, TChain* chain_, std::string title, int x_nBins, double x_min, double x_max, int y_nBins, double y_min, double y_max/*, double y_plotmin =0., double y_plotmax=-1.*/) :
      name(name_), formulax(formulax_), formulay(formulay_), chain(chain_),
    ...
    std::string name, formulax, formulay;
    TChain* chain;
