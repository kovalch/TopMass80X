...
void ensembleMasses()
{
  ...
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1665_1.00/job_*_ensemble.root");
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1695_1.00/job_*_ensemble.root");
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1715_1.00/job_*_ensemble.root");
  ...
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1735_1.00/job_*_ensemble.root");
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1755_1.00/job_*_ensemble.root");
  tree->Add("/nfs/dust/cms/user/mseidel/pseudoexperiments/topmass_paper_uncalibrated/lepton/Summer12_TTJetsMS1785_1.00/job_*_ensemble.root");
  
  hError = new TH1D("hError", "hError", 340, 164, 181);
  ...
  hError->GetYaxis()->SetTitle("Pseudo-experiments / 50 MeV");
  hError->GetYaxis()->SetTitleSize(0.05);
  hError->GetXaxis()->SetTitle("m_{t,extr} [GeV]");
  hPull->GetYaxis()->SetTitle("Pseudo-experiments");
  hPull->GetXaxis()->SetTitle("Mass pull");
  
  //// Do something :)
  
  TCanvas* cError = new TCanvas("cMasses", "cMasses", 600, 600);
