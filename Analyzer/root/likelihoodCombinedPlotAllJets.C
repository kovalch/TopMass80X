...
void likelihoodCombinedPlotAllJets() {
  ...
  TFile f2("../plot/Ideogram/Run2012_alljets_mass_vs_JES.root","read");
  ...
  TFile fh("../plot/Ideogram/Run2012_alljets_mass_vs_JESc.root","read");
  ...
  TGraphErrors* c1_gr2 = new TGraphErrors(1, mt1d, mt1d_jsf, mt1d_stat2, mt1d_jsferr);
                c1_gr2->SetLineColor(lineColor1);
                c1_gr2->SetLineWidth(lineWidthThin);
                c1_gr2->SetMarkerColor(lineColor1);
                c1_gr2->SetMarkerSize(2);
                ch_gr2->SetMarkerStyle(20);
  TGraphErrors* c1_gr1 = new TGraphErrors(1, mt1d, mt1d_jsf, mt1d_stat, mt1d_jsferr);
                c1_gr1->SetLineColor(lineColor1);
                c1_gr1->SetLineWidth(lineWidthThick);
                c1_gr1->SetMarkerColor(lineColor1);
                c1_gr1->SetMarkerSize(2);
  ...
  leg->AddEntry(c2_gr0, "2D", "LP");
  leg->AddEntry(ch_gr0, "hybrid", "LP");
  leg->AddEntry(c1_gr1, "1D", "LP");
