...
void TopMassControlPlots::doPlots()
{
  ...
  TChain* myChain = new TChain("analyzeHitFit/eventTree");
  ...
  // masses
  hists.push_back(MyHistogram("fitTop1Mass", ""+topBranchName+"fitTop1.M()", myChain, ";m_{t}^{fit} [GeV]; Permutations", 75, 50, 400));
  hists.push_back(MyHistogram("recoWAveMass", "("+topBranchName+"recoW1[0].M()+"+topBranchName+"recoW2[0].M())/2.0", myChain, ";m_{W}^{reco} [GeV]; Events", 60, 65, 125));
  hists.push_back(MyHistogram("recoW1Mass", ""+topBranchName+"recoW1.M()", myChain, ";m_{W}^{reco} [GeV]; Permutations", 60, 0, 300));

  // light pulls
  hists.push_back(MyHistogram("pullW1Prod1_W1Prod2", "abs(TVector2::Phi_mpi_pi(jet.pull["+topBranchName+"recoJetIdxW1Prod1].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitW1Prod2.Phi()-"+topBranchName+"fitW1Prod1.Phi()),-("+topBranchName+"fitW1Prod2.Eta()-"+topBranchName+"fitW1Prod1.Eta())))))", myChain, ";#theta_{pull}^{q_{1} #rightarrow q_{2}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedW1Prod1_W1Prod2", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxW1Prod1].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitW1Prod2.Phi()-"+topBranchName+"fitW1Prod1.Phi()),-("+topBranchName+"fitW1Prod2.Eta()-"+topBranchName+"fitW1Prod1.Eta())))))", myChain, ";#theta_{pull,ch}^{q_{1} #rightarrow q_{2}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedW1Prod1_beam", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxW1Prod1].Phi()-(TMath::Pi()+TMath::ATan2(-1,-0))))", myChain, ";#theta_{pull,ch}^{q_{1} #rightarrow beam}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedW1Prod2_W1Prod1", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxW1Prod2].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitW1Prod1.Phi()-"+topBranchName+"fitW1Prod2.Phi()),-("+topBranchName+"fitW1Prod1.Eta()-"+topBranchName+"fitW1Prod2.Eta())))))", myChain, ";#theta_{pull,ch}^{q_{2} #rightarrow q_{1}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedW1Prod2_beam", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxW1Prod2].Phi()-(TMath::Pi()+TMath::ATan2(-1,-0))))", myChain, ";#theta_{pull,ch}^{q_{2} #rightarrow beam}; Permutations", 20, 0, 3.1416));

  // b pulls
  hists.push_back(MyHistogram("pullChargedB1_B2", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxB1].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitB2.Phi()-"+topBranchName+"fitB1.Phi()),-("+topBranchName+"fitB2.Eta()-"+topBranchName+"fitB1.Eta())))))", myChain, ";#theta_{pull,ch}^{b_{1} #rightarrow b_{2}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedB1_beam", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxB1].Phi()-(TMath::Pi()+TMath::ATan2(-1,-0))))", myChain, ";#theta_{pull,ch}^{b_{1} #rightarrow beam}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedB2_B1", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxB2].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitB1.Phi()-"+topBranchName+"fitB2.Phi()),-("+topBranchName+"fitB1.Eta()-"+topBranchName+"fitB2.Eta())))))", myChain, ";#theta_{pull,ch}^{b_{2} #rightarrow b_{1}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedB2_beam", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxB2].Phi()-(TMath::Pi()+TMath::ATan2(-1,-0))))", myChain, ";#theta_{pull,ch}^{b_{2} #rightarrow beam}; Permutations", 20, 0, 3.1416));

  // mixed pulls
  hists.push_back(MyHistogram("pullChargedW1Prod1_B1", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxW1Prod1].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitB1.Phi()-"+topBranchName+"fitW1Prod1.Phi()),-("+topBranchName+"fitB1.Eta()-"+topBranchName+"fitW1Prod1.Eta())))))", myChain, ";#theta_{pull}^{q_{1} #rightarrow b_{1}}; Permutations", 20, 0, 3.1416));
  hists.push_back(MyHistogram("pullChargedB1_W1Prod1", "abs(TVector2::Phi_mpi_pi(jet.pullCharged["+topBranchName+"recoJetIdxB1].Phi()-(TMath::Pi()+TMath::ATan2(-("+topBranchName+"fitW1Prod1.Phi()-"+topBranchName+"fitB1.Phi()),-("+topBranchName+"fitW1Prod1.Eta()-"+topBranchName+"fitB1.Eta())))))", myChain, ";#theta_{pull}^{b_{1} #rightarrow q_{1}}; Permutations", 20, 0, 3.1416));

  // others
  hists.push_back(MyHistogram("fitProb", ""+topBranchName+"fitProb", myChain, ";P_{gof}; Permutations", 50, 0, 1.0));
  hists.push_back(MyHistogram("fitProbBest", ""+topBranchName+"fitProb[0]", myChain, ";P_{gof}; Events", 50, 0, 1.0));
  hists.push_back(MyHistogram("deltaRbbBest", "sqrt(pow("+topBranchName+"fitB1[0].Eta()-"+topBranchName+"fitB2[0].Eta(),2) + pow(TVector2::Phi_mpi_pi("+topBranchName+"fitB1[0].Phi()-"+topBranchName+"fitB2[0].Phi()),2))", myChain, ";#DeltaR_{b#bar{b}}; Events", 50, 1, 6));
  ...
  hists.push_back(MyHistogram("topPt", ""+topBranchName+"fitTop1.Pt()", myChain, ";p_{T,t}^{fit} [GeV]; Permutations", 40, 0, 400));
  hists.push_back(MyHistogram("fitRlb", "("+topBranchName+"fitB1.Pt()+"+topBranchName+"fitB2.Pt())/("+topBranchName+"fitW1Prod1.Pt()+"+topBranchName+"fitW1Prod2.Pt())", myChain, ";R_{lb}^{fit}; Permutations", 40, 0, 4));
  hists.push_back(MyHistogram("recoRlb", "("+topBranchName+"recoB1.Pt()+"+topBranchName+"recoB2.Pt())/("+topBranchName+"recoW1Prod1.Pt()+"+topBranchName+"recoW1Prod2.Pt())", myChain, ";R_{lb}^{reco}; Permutations", 40, 0, 4));

  hists.push_back(MyHistogram("B1EtWeightedSigmaPhi", "BRegJet.EtWeightedSigmaPhi["+topBranchName+"recoJetIdxB1]", myChain, ";width in #varphi; Events", 20, 0, 0.4));
  hists.push_back(MyHistogram("B1fMuon", "jet.fMuon["+topBranchName+"recoJetIdxB1]", myChain, ";muon fraction; Events", 20, 0, 1.0));
  hists.push_back(MyHistogram("B1fMuon_ext", "jet.fMuon["+topBranchName+"recoJetIdxB1]", myChain, ";muon fraction; Events", 19, 0.05, 1.0));
  hists.push_back(MyHistogram("B1GBRFactor", "BRegJet.BRegGBRTrainResult["+topBranchName+"recoJetIdxB1]", myChain, ";regression factor; Events", 20, 0.5, 1.5));
  hists.push_back(MyHistogram("B1TMVAFactor", "BRegJet.BRegResult["+topBranchName+"recoJetIdxB1]", myChain, ";regression factor; Events", 20, 0.5, 1.5));

  hists.push_back(MyHistogram("B1fitTop1MassVsTMVAFactor", topBranchName+"fitTop1.M()", "BRegJet.BRegResult["+topBranchName+"recoJetIdxB1]", myChain, ";m_{t}^{fit} [GeV];regression factor", 20, 50, 400, 20, 0.5, 1.5));

  hists.push_back(MyHistogram("B1LeadingChargedConstFraction", "BRegJet.leadingChargedConstPt["+topBranchName+"recoJetIdxB1]/BRegJet.jetPtCorr["+topBranchName+"recoJetIdxB1]", myChain, ";leading charged const. p_{T} fraction;Events", 20, 0, 1));

  hists.push_back(MyHistogram("B1PgofVsfitTop1Mass", topBranchName+"fitTop1.M()", topBranchName+"fitProb", myChain, ";m_{t}^{fit} [GeV];P_{gof}", 20, 50, 400, 20, 0.0, 1.0));
  hists.push_back(MyHistogram("B1PgofVsnVertex", "weight.nVertex", topBranchName+"fitProb", myChain, ";N_{vtx};P_{gof}", 20, 0, 60, 20, 0.0, 1.0));
  hists.push_back(MyHistogram("B1fitTop1MassVsnVertex", "weight.nVertex", topBranchName+"fitTop1.M()", myChain, ";N_{vtx};m_{t}^{fit} [GeV]", 20, 0, 60, 20, 50, 400));
...

  {
    ...
    for(MySample& sample : samples){
      ...
      for(MyHistogram& hist : hists) {
        hist.Init(chain);
        if     (sample.type == kSig    ) { hist.AddSignal(&sample);          /*std::cout << "adding sig" << std::endl;    */}
        else if(sample.type == kBkg    ) { hist.AddBackground(&sample);	     /*std::cout << "adding bkg" << std::endl;    */}
        else if(sample.type == kSigVar ) { hist.AddSignalVariation(&sample); /*std::cout << "adding sigvar" << std::endl; */}
      }
  ...
  std::cout << "summing yields" << std::endl;
  bool firstHist = true;
  for(MyHistogram& hist : hists){
    ...
    double integralS = 0; for(TH1F* sig : hist.Sig1D()) {
    ...
    double integralB = 0; for(TH1F* bkg : hist.Bkg1D()) {
