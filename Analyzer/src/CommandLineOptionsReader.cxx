...
CommandLineOptionsReader::CommandLineOptionsReader(int ac, char** av) {
...
boost::program_options::variables_map* CommandLineOptionsReader::programOptions_(0);

void
CommandLineOptionsReader::ReadProgramOptions(int ac, char** av) {
  if(!programOptions_){
...
CommandLineOptionsReader::GetProgramOptions(){
  return 0;
}
