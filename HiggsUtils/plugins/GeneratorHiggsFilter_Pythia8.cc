...
class GeneratorHiggsFilter_Pythia8 : public edm::EDFilter {
    public:
        explicit GeneratorHiggsFilter_Pythia8(const edm::ParameterSet&);
        ~GeneratorHiggsFilter_Pythia8();
...
//
GeneratorHiggsFilter_Pythia8::GeneratorHiggsFilter_Pythia8(const edm::ParameterSet& iConfig):
...
GeneratorHiggsFilter_Pythia8::~GeneratorHiggsFilter_Pythia8()
{}
...
bool
GeneratorHiggsFilter_Pythia8::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    // Access particles stored in Reco GenParticles Collection
    edm::Handle<edm::View<reco::GenParticle>> v_genParticle;
    iEvent.getByLabel(src_, v_genParticle);
    ...
    for(edm::View<reco::GenParticle>::const_iterator cand = v_genParticle->begin(); cand!=v_genParticle->end(); ++cand) {      
        if(cand->pdgId() != 25 || cand->status() != 62 ) continue;
        ...
        for(size_t i = 0; i < cand->numberOfDaughters(); ++i){
               std::cout<<"Tochter:  "<<cand->daughter(i)->pdgId()<<std::endl;    
...
void 
GeneratorHiggsFilter_Pythia8::beginJob()
{
...
void 
GeneratorHiggsFilter_Pythia8::endJob()
{}

// ------------ method called when starting to processes a run  ------------
bool 
GeneratorHiggsFilter_Pythia8::beginRun(edm::Run&, edm::EventSetup const&)
{ 
    return true;
}
...
bool 
GeneratorHiggsFilter_Pythia8::endRun(edm::Run&, edm::EventSetup const&)
{
    return true;
}
...
bool 
GeneratorHiggsFilter_Pythia8::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
    return true;
}
...
bool 
GeneratorHiggsFilter_Pythia8::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
    return true;
}
...
void
GeneratorHiggsFilter_Pythia8::fillDescriptions(edm::ConfigurationDescriptions& descriptions)
{
...
DEFINE_FWK_MODULE(GeneratorHiggsFilter_Pythia8);
